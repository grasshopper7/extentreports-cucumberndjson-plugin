...
public class ReporterInitializer {
	...
	@Inject
	public ReporterInitializer(ReportProperties reportProperties, ReporterRunData runData, ExtentReportsCucumberLogger logger) {
	...
	public ReportAggregateUpdater instantiatReportAggregateUpdater() {
		return new ReportAggregateUpdater(runData);
	}
